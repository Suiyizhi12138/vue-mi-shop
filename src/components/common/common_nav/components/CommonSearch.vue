<template>
  <div class="search-container">
    <input
      ...
      v-on:blur="onBlur"
      v-model="searchKey"
      v-on:keyup.enter="submitSearch(searchKey)"
      v-on:change="getSearchKeys"
    />
...
export default {
  ...
  data(){
    return {
      ...
      isHoverAll: false,
      searchkeys: [
        { id: "1", name: "全部商品", type: "category" },
        { id: "2", name: "电视", type: "category" },
        { id: "3", name: "黑鲨4", type: "product" },
        { id: "4", name: "小米11", type: "product" },
        { id: "5", name: "耳机", type: "category" },
        { id: "6", name: "Redmi", type: "category" }
      ],
      searchIndex: 0,
      holderkeys: ["小米11","电视","笔记本"],//
      searchKey: "", //搜索框提交关键词
      holderKey: "Redmi K40", //搜索框默认关键词
      holderTerval: null,//
    }
  },
  mounted(){
    this.holderTerval =  setInterval(() => {
  ...
  beforeDestory(){
    clearInterval(this.holderTerval);
  },
  methods: {
    //搜索框focus 事件
    focusEvent() {
