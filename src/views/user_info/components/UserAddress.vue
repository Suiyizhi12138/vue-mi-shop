...
import NewAddress from "@/components/user_info/address/NewAddress";
import Loading from "@/components/common/Loading";
import ChooseDistrict from '@/components/user_info/address/ChooseDistrict';
import SearchDistrict from '@/components/user_info/address/SearchDistrict';
export default {
  components: {
    Modal,
    NewAddress,
