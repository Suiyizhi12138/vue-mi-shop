    ...
    <div class="form-container">
      <div class="add-form clearfix">
        ...
        <div class="section section-district">
          ...
          <search-district v-if="isShowSD" v-on:showChoose="showCD" v-on:closeForm="handleCloseForm" ></search-district>
      ...
      <div class="add-btn clearfix">
        <div class="add-btn-box">
          <button class="btn-add" @click="updateAddress(address.id)">确定</button>
